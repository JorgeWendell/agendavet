...
const formSchema = z
  .object({
    ...
    appointmentPrice: z.number().min(1, { message: "Preço é obrigatorio" }),
    availableFromWeekDay: z
      .string()
      .min(1, { message: "Dia da semana é obrigatorio" }),
...
const UpsertDoctorForm = ({ onSuccess }: UpsertDoctorFormProps) => {
  ...
  const upsertDoctorAction = useAction(upsertDoctor, {
    ...
    onError: () => {
      toast.error("Erro ao adicionar Medico");
    },
  });
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Adicionar medico</DialogTitle>
        <DialogDescription>
